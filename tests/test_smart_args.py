...
def test_recursive_use_of_evaluated_and_isolated():
    ...
    def foobar(
        a,
        b=Isolated(),
        c=Evaluated(lambda: 42),
        d=Evaluated(lambda: foobar(3, b=Isolated())),
    ):
        return a, b, c, d
...
def test_nested_evaluated_and_isolated():
    ...
    def kerplunk(
        ...
        b=Isolated(),
        c=Evaluated(lambda: 42),
        d=Evaluated(lambda: kerplunk(3, b=Isolated())),
    ):
        return a, b, c, d
...
def test_chaining_evaluated_and_isolated():
    ...
    def doop(
        ...
        b=Isolated(),
        c=Evaluated(lambda: 42),
        d=Evaluated(lambda: doop(3, b=Isolated())),
    ):
        return a, b, c, d
...
def test_combination_of_evaluated_and_isolated():
    ...
    def kaboom(
        ...
        b=Isolated(),
        c=Evaluated(lambda: 42),
        d=Evaluated(lambda: kaboom(3, b=Isolated())),
    ):
        return a, b, c, d
...
def test_overriding_nested_evaluated_and_isolated():
    ...
    def kludge(
        ...
        b=Isolated(),
        c=Evaluated(lambda: 42),
        d=Evaluated(lambda: kludge(3, b=Isolated())),
    ):
        return a, b, c, d
...
def test_evaluted_override_nested_evaluated():
    ...
    def bang(
        ...
        b=Isolated(),
        c=Evaluated(lambda: 42),
        d=Evaluated(lambda: bang(3, b=Isolated())),
    ):
        return a, b, c, d
